...
public class ControllerServlet extends HttpServlet {
	...
	private void updateJoke(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException {
	...
	private void showStats(HttpServletRequest request, HttpServletResponse response)
		...
		if (tag1 == "" && tag2 == "") {
			...
			List<User> listUsers = jokeDAO.listStatUsers(tag1, tag2);
	...
	private void highlyRevJokes(HttpServletRequest request, HttpServletResponse response)
		...
		if (selectedUser == null) {
			List<User> listRegUsers = jokeDAO.listRegisterUsers();
			request.setAttribute("listRegUsers", listRegUsers);

			RequestDispatcher dispatcher = request.getRequestDispatcher("HighlyRevJokes.jsp");
			dispatcher.forward(request, response);
		} else {
			List<Joke> listJokes = jokeDAO.listHighlyJoke(selectedUser);
	...
	private void mostActiveUser(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException, SQLException {
		List<User> listActiveUsers = jokeDAO.mostActiveUsers();
		request.setAttribute("listActiveUsers", listActiveUsers);
	...
	private void checkCommonFrnd(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException, SQLException {
		String selectedUser1 = request.getParameter("selectedUser1");
		String selectedUser2 = request.getParameter("selectedUser2");
		if (selectedUser1 == null && selectedUser2 == null) {
			...
			List<String> listCommonUsers = jokeDAO.checkCommonUsers(selectedUser1, selectedUser2);
	...
	private void userNeverPstExcellentJ(HttpServletRequest request, HttpServletResponse response)
		...
		List<String> listUsers = jokeDAO.listNeverPstExcJUsers();
		request.setAttribute("listUsers", listUsers);
	...
	private void userNeverPstPoorR(HttpServletRequest request, HttpServletResponse response)
		...
		List<String> listUsers = jokeDAO.userNeverPstPoorR();
		request.setAttribute("listUsers", listUsers);
	...
	private void userAlwaysPstPoorR(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException, SQLException {
		List<String> listUsers = jokeDAO.userAlwaysPstPoorR();
		request.setAttribute("listUsers", listUsers);
	...
	private void userNeverRecPoorR(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException, SQLException {
		List<String> listUsers = jokeDAO.userNeverRecPoorR();
		request.setAttribute("listUsers", listUsers);
	...
	private void userPairExcellentR(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException, SQLException {
		List<UserPair> listUsers = jokeDAO.userPairExcellentR();
		request.setAttribute("listUsers", listUsers);
